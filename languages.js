...
//         const optionItem = `<li class="option" id= ${language.languageId} dataValue="${language.languageCode}">${language.languageName}</li>`;
...
//         var defaultInputLanguage = languages[0];
//         var defaultOutputLanguage = languages[1];
...
//         inputSelected.setAttribute('dataValue', defaultInputLanguage.languageCode);
//         inputSelected.setAttribute('dataId', defaultInputLanguage.languageId);
...
//         outputSelected.setAttribute('dataValue', defaultOutputLanguage.languageCode);
//         outputSelected.setAttribute('dataId', defaultOutputLanguage.languageId);
//     }
